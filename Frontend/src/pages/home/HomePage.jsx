          ...
          <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
            ...
            >
              ...
              <motion.div 
                ...
                className="absolute -right-6 -top-6 bg-white dark:bg-gray-800 shadow-lg rounded-xl p-3 flex items-center gap-2 border border-gray-100 dark:border-gray-700"
              >
                <div className="bg-emerald-100 text-emerald-700 p-2 rounded-lg">
                  <FaRegLightbulb className="w-5 h-5" />
                </div>
                <span className="font-semibold text-gray-800 dark:text-gray-100">AI Powered</span>
              </motion.div>
              ...
              <motion.div 
                ...
                className="absolute -left-6 -bottom-6 bg-white dark:bg-gray-800 shadow-lg rounded-xl p-3 flex items-center gap-2 border border-gray-100 dark:border-gray-700"
              >
                <div className="bg-indigo-100 text-indigo-700 p-2 rounded-lg">
                  <FaRegStar className="w-5 h-5" />
                </div>
                <span className="font-semibold text-gray-800 dark:text-gray-100">ATS Optimized</span>
              </motion.div>
              ...
              <motion.div 
                ...
                className="absolute right-20 -bottom-3 bg-white dark:bg-gray-800 shadow-lg rounded-xl p-3 flex items-center gap-2 border border-gray-100 dark:border-gray-700"
              >
                <div className="bg-amber-100 text-amber-700 p-2 rounded-lg">
                  <FaRegClock className="w-5 h-5" />
                </div>
                <span className="font-semibold text-gray-800 dark:text-gray-100">Quick Setup</span>
              </motion.div>
            </motion.div>
          </div>
        </div>
