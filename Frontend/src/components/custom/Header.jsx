...
import { addUserData } from "@/features/user/userFeatures";
import { motion } from "framer-motion";
import { FaUser, FaSignOutAlt, FaTachometerAlt, FaIdCard } from "react-icons/fa";
                ...
                {userDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 z-50 py-2 text-left">
                    ...
                    <div className="px-4 py-3">
                      ...
                      <div className="mb-2">
                        <div className="text-xs text-gray-500 mb-1 flex items-center"><FaIdCard className="inline mr-1"/> NIAT ID</div>
                        <div className="text-sm font-medium text-gray-800">{user.niatId || "Not Available"}</div>
                      </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg mb-3">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        <div className="font-medium">{user.fullName || "User"}</div>
                        <div className="text-xs text-gray-500">{user.email}</div>
                        <div className="text-xs text-gray-500">{user.niatId}</div>
                      </div>
                    </div>
                  </div>
                )}
