                  ...
                  {userDropdownOpen && (
                    <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 z-50 py-2 text-left">
                      ...
                      <div className="px-4 py-3">
                        ...
                        <button onClick={() => setChangePasswordOpen(true)} className="w-full text-left text-sm text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300 flex items-center gap-2 mt-2 pt-2 border-t border-gray-100 dark:border-gray-700">
            ...
            <div className="border-t border-gray-100 dark:border-gray-700 px-6 py-4">
              {user ? (
                <div className="flex flex-col gap-3">
                  ...
                  {!isDashboardPage && (<Button variant="outline" className="w-full justify-center border-2 border-indigo-200 text-indigo-600 hover:bg-indigo-50 flex items-center gap-2 dark:text-indigo-300 dark:border-indigo-700 dark:hover:bg-indigo-900/50" onClick={() => { navigate("/dashboard"); setMenuOpen(false); }}><FaTachometerAlt className="w-4 h-4" />Dashboard</Button>)}
